...
const AiSummary = ({ summary = "" }) => {
  ...
  return (
    <section className="m-0" aria-label="AI summary">
      <style>{`
        @keyframes news-ai-summary-border-snake {
          from { stroke-dashoffset: 100; }
          to { stroke-dashoffset: -100; }
        }

        .news-ai-summary-border-snake {
          stroke: #2563eb;
          stroke-width: 2;
          stroke-dasharray: 14 86;
          stroke-linecap: round;
          animation: news-ai-summary-border-snake 1.3s linear infinite;
            ...
            >
              ...
              >
                {isTyping ? (
                  ...
                  >
                    <rect
                      className="news-ai-summary-border-snake"
                      x="0"
                      y="0"
                      width="100"
                      height="100"
