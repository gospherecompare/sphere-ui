...
const CompetitorCard = ({
  ...
  return (
    <article className="group relative w-[84vw] max-w-[320px] shrink-0 overflow-hidden rounded-lg  bg-white  transition-colors duration-200 hover:border-blue-200 sm:w-[280px]">
