...
const sections = [
  {
    ...
    paragraphs: [
      "This Privacy Policy explains how MobileX handles information when you visit mobilex.in, use smartphone discovery and comparison features, read editorial content, submit a contact request or interact with related services.",
...

  {
    ...
    bullets: [
      "Provide and maintain smartphone discovery, comparison, news and support features",
...

  {
    ...
    paragraphs: [
      `Privacy questions and requests can be sent to ${CONTACT_EMAIL}. Include enough information to understand the request, but do not send passwords, payment details or government identification unless specifically required through a secure process.`,
    ],
  },
];
